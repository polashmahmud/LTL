<div class="d-flex space-x-1">
    ...
    <a href="{{ route('settings.menus.edit', $row) }}" class="btn btn-sm">Edit</a>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                <h3>Are you sure?</h3>
                <div class="text-muted">Do you really want to remove <code>{{ $row->name }}</code> menu? What you've done cannot be undone.</div>
            </div>
                ...
                <div class="w-100">
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <form id="delete-role-{{$row->id}}" action="{{ route('settings.menus.destroy', $row->id) }}" method="POST" class="d-none">
                                @csrf
                                @method('DELETE')
                            </form>
                        </div>
